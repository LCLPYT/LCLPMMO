        ...
        switch (action) {
            ...
            case PLAY_YT:
                if (file.startsWith("url:")) {
                    ...
                    MusicSystem.playYtSearch(file.substring("search:".length()), feedback);
                else if (file.startsWith("downloaded:"))
                    MusicSystem.playDownloaded(file.substring("downloaded:".length()), feedback);
                break;
            case VOLUME:
